...
class MoodService {
  ...
  MoodService({String assetsPath = 'assets/config/mood'})
  ...
  Future<MoodResponse> calculateMood({
    ...
    final baseConfig = await _loadJson('$_assetsPath/base.json');
    final zoneConfig = await _loadJson('$_assetsPath/zones/$climateZone.json');
